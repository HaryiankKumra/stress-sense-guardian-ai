...
const IntroductionPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: "Advanced machine learning algorithms analyze your physiological data in real-time to detect stress patterns.",
    ...
    },
    {
      ...
      description: "Get instant feedback and personalized recommendations to manage stress before it impacts your wellbeing.",
  ...
  const stats = [
    ...
    { number: "98%", label: "Satisfaction", icon: <TrendingUp className="w-6 h-6" /> }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in">
              Stress<span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Guard</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered stress detection using physiological signals and facial analysis. 
              Take control of your mental wellbeing with real-time insights.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/login">
                <Button variant="outline" className="border-2 border-slate-300 text-slate-300 hover:bg-slate-300 hover:text-slate-900 px-8 py-3 text-lg font-semibold rounded-full transition-all duration-200">
                  Sign In
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Cutting-edge technology meets intuitive design to provide comprehensive stress management
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 transform hover:scale-105">
                <CardHeader>
      ...
      <div className="py-20 bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Passionate experts in AI, healthcare, and technology working to revolutionize stress management
            </p>
          </div>
              ...
              <Card key={index} className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 transform hover:scale-105">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="flex justify-center space-x-3">
                    ...
                    <a href={`mailto:${member.email}`} className="text-slate-400 hover:text-blue-400 transition-colors">
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already taking control of their stress with StressGuard's AI-powered insights.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                <span className="text-2xl font-bold text-white">StressGuard</span>
              </div>
              <p className="text-slate-400 mb-4 max-w-md">
                Advanced AI-powered stress detection and management platform for better mental health.
              </p>
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 text-center">
            <p className="text-slate-400">
              © 2024 StressGuard. All rights reserved. Built with ❤️ for better mental health.
            </p>
          </div>
        </div>
      </footer>
