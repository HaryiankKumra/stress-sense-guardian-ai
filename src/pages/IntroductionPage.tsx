                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300">
                        Periodic health checkups and manual stress assessments
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-white mb-6">
              Built by passionate researchers
            </h2>
            <p className="text-slate-300 max-w-2xl mx-auto">
              Our multidisciplinary team combines expertise in AI, biomedical
              engineering, and healthcare to create innovative stress detection
              solutions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-slate-300 text-sm">
                  Clinical Validation & User Experience
                </p>
              </CardContent>
            </Card>
          </div>
